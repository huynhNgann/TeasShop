                                    ...
                                    <ul class="conversation-list slimscroll" style="min-height: 330px;">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="{{asset('backend/assets/images/users/avatar-2.jpg')}}" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-lg">
                                    <li class="list-group-item border-0 pt-2">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-4.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-5.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-6.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-7.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-8.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                        <span class="float-right badge badge-info mt-2">Webdesigner</span>
                                    ...
                                    <li class="list-group-item border-0 pb-1">
                                        <a href="" class=" mr-3">
                                            <img src="{{asset('backend/assets/images/users/avatar-9.jpg')}}" alt="user-img" class="avatar-sm rounded">
                                        </a>
                                        <span class="float-right badge badge-warning mt-2">Webdeveloper</span>
                                        <a href="">John Deo</a>
                                    </li>
